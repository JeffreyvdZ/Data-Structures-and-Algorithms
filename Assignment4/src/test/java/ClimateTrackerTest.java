...
public class ClimateTrackerTest {
    ...
    @Test void checkColdestYearReturnOfNegativeOne() {
        Map<Integer, Station> integerStationMap = new HashMap<>();
        integerStationMap.put(1, new Station(1, "Test"));
        climateTracker.setStations(integerStationMap);
        assertEquals(-1, climateTracker.coldestYear());
    }
}
